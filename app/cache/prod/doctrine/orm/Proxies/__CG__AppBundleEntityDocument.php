...
class Document extends \AppBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'createdBy', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'isPublic', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'image', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'document', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'module', '' . "\0" . 'AppBundle\\Entity\\Document' . "\0" . 'logs');
        }

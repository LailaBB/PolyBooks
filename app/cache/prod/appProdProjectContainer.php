...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->aliases = array(
            ...
            'security.user_checker.admin' => 'security.user_checker.login',
            'security.user_checker.api' => 'security.user_checker.login',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'polybooks.fr.mysql', 'port' => NULL, 'dbname' => 'polybooks_fr', 'user' => 'polybooks_fr', 'password' => 'ytxrSCFr', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_18db8447504bbc9f2950f4180739622634f3969a089d0d2a898ce770debc7c15');
    ...
    {
        return $this->services['fos_rest.converter.request_body'] = new \FOS\RestBundle\Request\RequestBodyParamConverter($this->get('jms_serializer'), '', '', $this->get('validator', ContainerInterface::NULL_ON_INVALID_REFERENCE), 'violations');
    }
    ...
    protected function getFosRest_ExceptionFormatNegotiatorService()
    {
        ...
        $instance->add($this->get('fos_rest.request_matcher.8615024800e4193600fd69885f7587200427156c3f94286d4b2ddc9c87897c17c762ebe2'), array('priorities' => array(0 => 'json', 1 => 'xml'), 'fallback_format' => 'json', 'prefer_extension' => false, 'methods' => NULL, 'stop' => false));
    ...
    {
        return $this->services['fos_rest.mime_type_listener'] = new \FOS\RestBundle\EventListener\MimeTypeListener(array('enabled' => true, 'formats' => array('json' => array(0 => 'application/json', 1 => 'application/x-json', 2 => 'application/vnd.app.categories+json', 3 => 'application/vnd.app.categories+json;v=1.0', 4 => 'application/vnd.app.categories+json;v=2.0'), 'xml' => array(0 => 'text/xml', 1 => 'application/vnd.app.categories+xml', 2 => 'application/vnd.app.categories+xml;v=1.0', 3 => 'application/vnd.app.categories+xml;v=2.0')), 'service' => NULL), $this->get('fos_rest.format_negotiator'));
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.token_storage'), $this->get('security.user_checker.login'), $this->get('security.authentication.session_strategy'), $this);
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.openssl_key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\OpenSSLKeyLoader(($this->targetDirs[2].'/var/jwt/private.pem'), ($this->targetDirs[2].'/var/jwt/public.pem'), 'salem');
    }
    ...
    protected function getNelmioApiDoc_Formatter_HtmlFormatterService()
    {
        ...
        $instance->setApiName('Digital Library API documentation');
        ...
        $instance->setBodyFormats(array(0 => 'form', 1 => 'json', 2 => 'xml'));
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login'), 'security.firewall.map.context.admin' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, 'homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout_admin'));
        ...
        $h->setOptions(array('login_path' => 'login_admin', 'always_use_default_target_path' => false, 'default_target_path' => '/admin', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $i->setOptions(array('login_path' => 'login_admin', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'admin', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'admin', $h, $i, array('check_path' => 'check_admin', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57755783e6a930.08078425', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'login_admin', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        $b = new \Lexik\Bundle\JWTAuthenticationBundle\Security\Firewall\JWTListener($a, $this->get('security.authentication.manager'), array('authorization_header' => array('enabled' => true, 'prefix' => 'Bearer', 'name' => 'Authorization'), 'cookie' => array('enabled' => false, 'name' => 'BEARER'), 'query_parameter' => array('enabled' => false, 'name' => 'bearer'), 'throw_exceptions' => false, 'create_entry_point' => true, 'authentication_provider' => 'lexik_jwt_authentication.security.authentication.provider', 'authentication_listener' => 'lexik_jwt_authentication.security.authentication.listener'));
        $b->setDispatcher($this->get('event_dispatcher'));
        $b->addTokenExtractor(new \Lexik\Bundle\JWTAuthenticationBundle\TokenExtractor\AuthorizationHeaderTokenExtractor('Bearer', 'Authorization'));

        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $b, 2 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', new \Lexik\Bundle\JWTAuthenticationBundle\Security\Http\EntryPoint\JWTEntryPoint(), NULL, NULL, $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), true));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57755783e6a930.08078425', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b, false));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f458fb822b4365c62b2b27500b22bf65bf8e129a');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/check'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/logout'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/'), array(0 => 'ROLE_PROFESSOR'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $c = $this->get('security.user_checker.login');
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, $c, 'login', $d, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57755783e6a930.08078425'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, $c, 'admin', $d, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57755783e6a930.08078425'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($b, $c, 'main', $d, true), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57755783e6a930.08078425'), 6 => $e), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('admin', 'logout_admin', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_PROFESSOR' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_PROFESSOR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'polybooks.fr.mysql',
            'database_port' => NULL,
            'database_name' => 'polybooks_fr',
            'database_user' => 'polybooks_fr',
            'database_password' => 'ytxrSCFr',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'f458fb822b4365c62b2b27500b22bf65bf8e129a',
            'jwt_private_key_path' => ($this->targetDirs[2].'/var/jwt/private.pem'),
            'jwt_public_key_path' => ($this->targetDirs[2].'/var/jwt/public.pem'),
            'jwt_key_pass_phrase' => 'salem',
            'jwt_token_ttl' => 86400,
            'locale' => 'en',
            ...
            'kernel.secret' => 'f458fb822b4365c62b2b27500b22bf65bf8e129a',
            ...
            'fos_rest.converter.request_body.validation_errors_argument' => 'violations',
            ...
            'fos_rest.mime_types' => array(
                ...
                'formats' => array(
                    'json' => array(
                        ...
                        2 => 'application/vnd.app.categories+json',
                        3 => 'application/vnd.app.categories+json;v=1.0',
                        4 => 'application/vnd.app.categories+json;v=2.0',
                    ),
                    'xml' => array(
                        0 => 'text/xml',
                        1 => 'application/vnd.app.categories+xml',
                        2 => 'application/vnd.app.categories+xml;v=1.0',
                        3 => 'application/vnd.app.categories+xml;v=2.0',
                    ),
                ),
                'service' => NULL,
            ),
            ...
            'lexik_jwt_authentication.pass_phrase' => 'salem',
            ...
            'nelmio_api_doc.api_name' => 'Digital Library API documentation',
